...
const SubtitlePanel = () => {
  ...
  // Generic handler for textStyle properties
      ...
      <div className="grid grid-cols-2 gap-x-8 gap-y-6">
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              handleTextStyleChange("size", Number(e.target.value))
            }
          />
        </div>
        ...
        <div className="col-span-2">
          ...
          <div className="flex w-min rounded-md border border-gray-300">
            <button
              ...
              className={`p-2 ${
                textStyle.alignment === "left" ? "bg-gray-200" : "bg-white"
              }`}
            >
              Left
            </button>
            <button
              ...
              className={`p-2 border-l border-r ${
                textStyle.alignment === "center" ? "bg-gray-200" : "bg-white"
              }`}
            >
              Center
            </button>
            <button
              ...
              className={`p-2 ${
                textStyle.alignment === "right" ? "bg-gray-200" : "bg-white"
              }`}
            >
              Right
            </button>
